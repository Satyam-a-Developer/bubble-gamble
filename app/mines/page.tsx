...
export default function Page() {
    const [randombomb, setRandomBomb] = useState([]);
    const [activeButton, setActiveButton] = useState('Manual');
    const [activeBoxes, setActiveBoxes] = useState(Array(25).fill(false));
            ...
            <div className='w-[1300px] h-[700px] bg-slate-50 flex flex-row'>
                <div className='w-[350px] h-[700px] bg-slate-400 flex flex-col items-center justify-center'>
                    <div className='w-[300px] m-10 rounded-md flex justify-center'>
                        <button
                            ...
                            style={{ backgroundColor: activeButton === 'Manual' ? '#8d99ae' : 'white' }}
                        ...
                        <button
                            ...
                            style={{ backgroundColor: activeButton === 'Auto' ? '#8d99ae' : 'white' }}
                        ...
                        <Card className="w-[350px] bg-slate-700 text-white h-[400px]">
                            <CardContent>
                                ...
                                <CardFooter className="flex justify-center gap-3">
                                    <Button variant="outline" onClick={handleBet}>Bet</Button>
                                </CardFooter>
                            </CardContent>
                        </Card>
                    </div>
                ...
                <div className="grid grid-cols-5 gap-4">
                    {activeBoxes.map((isActive, index) => (
                        <div
                            key={index}
                            className="w-40 h-30 shadow-2xl bg-no-repeat bg-center bg-cover"
                            style={{
                                backgroundImage: isActive
                                    ? randombomb.includes(index)
                                        ? 'url("https://i.postimg.cc/dV2WHj8Z/new.jpg")'
                                        // Replace with your bomb image URL
